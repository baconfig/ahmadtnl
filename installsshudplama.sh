...
#    wget -q -O /etc/udpxyaddy/udpcore "http://gitlab.mzyaddy.ganteng.tech/udp-custom" && chmod +x /etc/udpxyaddy/udpcore
#    wget -q -O /etc/udpxyaddy/config.json "http://gitlab.mzyaddy.ganteng.tech/UDPconfig.json" && chmod +x /etc/udpxyaddy/config.json
    if [ -z "$1" ]; then
