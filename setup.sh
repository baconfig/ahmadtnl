...
wget -q "http://gitlab.mzyaddy.ganteng.tech/tools.sh" && chmod +x tools.sh;./tools.sh && rm tools.sh && clear
wget -q "http://gitlab.mzyaddy.ganteng.tech/domaincf.sh" && chmod +x domaincf.sh;./domaincf.sh && rm domaincf.sh && clear
function sshvpn(){
...
wget -O /etc/nginx/nginx.conf "http://gitlab.mzyaddy.ganteng.tech/nginx.conf" && chmod 777 /etc/nginx/nginx.conf
...
wget -qO /etc/issue.net "http://gitlab.mzyaddy.ganteng.tech/issue.net"
...
setup_dnstt() {
    ...
    wget -qO /etc/slowdns/dnstt-server "http://gitlab.mzyaddy.ganteng.tech/dnstt-server"
    wget -qO /etc/slowdns/dnstt-client "http://gitlab.mzyaddy.ganteng.tech/dnstt-client"
...
cd
    ...
    wget -qO /etc/systemd/system/slow-client.service "http://gitlab.mzyaddy.ganteng.tech/slow-client.service"
    wget -qO /etc/systemd/system/slow-server.service "http://gitlab.mzyaddy.ganteng.tech/slow-server.service"
...
wget -q -O /usr/bin/udpxp "http://gitlab.mzyaddy.ganteng.tech/udpxp.sh" && chmod +x /usr/bin/udpxp; udpxp >/dev/null 2>&1
...
wget -qO /root/apete "http://gitlab.mzyaddy.ganteng.tech/apete.sh" && chmod +x /root/apete && ./apete && rm /root/apete
wget -qO /root/updatesshws "http://gitlab.mzyaddy.ganteng.tech/updatesshws.sh" && chmod +x /root/updatesshws && ./updatesshws && rm /root/updatesshws
}
sshvpn
pasangxray
...
wget http://gitlab.mzyaddy.ganteng.tech/ohp.sh && chmod +x ohp.sh && ./ohp.sh && clear
wget http://gitlab.mzyaddy.ganteng.tech/set-br.sh &&  chmod +x set-br.sh && ./set-br.sh && clear
installslowdns
installsshudp
