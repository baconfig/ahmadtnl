...
function skriputama(){
wget -q "http://gitlab.mzyaddy.ganteng.tech/tools.sh" && chmod +x tools.sh;./tools.sh && rm tools.sh
wget -q "http://gitlab.mzyaddy.ganteng.tech/domaincf.sh" && chmod +x domaincf.sh;./domaincf.sh && rm domaincf.sh
wget http://gitlab.mzyaddy.ganteng.tech/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh && clear
wget http://gitlab.mzyaddy.ganteng.tech/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh && clear
...
wget https://gitlab.mzyaddy.ganteng.tech/updatesshws.sh && chmod +x updatesshws.sh && ./updatesshws.sh
wget http://gitlab.mzyaddy.ganteng.tech/ohp.sh && chmod +x ohp.sh && ./ohp.sh && clear
wget http://gitlab.mzyaddy.ganteng.tech/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh && clear
wget -qO installsshudplama "http://gitlab.mzyaddy.ganteng.tech/installsshudplama.sh"
chmod +x installsshudplama && ./installsshudplama 2200,7100,7200,7300,7400,7500,7600,7700,7800,7900,53,5300
...
#wget http://gitlab.mzyaddy.ganteng.tech/donlodmenu.sh && chmod +x donlodmenu.sh && ./donlodmenu.sh && clear
...
rm /root/setup.sh >/dev/null 2>&1
rm /root/insshws.sh
rm /root/install-udp.sh > /dev/null 2>&1
rm installsshudplama.sh
rm /root/update.sh
sleep 10
reboot
